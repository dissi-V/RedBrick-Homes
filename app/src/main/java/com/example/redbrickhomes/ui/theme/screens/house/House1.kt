package com.example.redbrickhomes.ui.theme.screens.house
...
@Composable
fun House1Screen(navController: NavHostController){
    Column(
        modifier = Modifier
        ...
        Text(
            text = "Located along Muthithi Road, Nairobi",
            fontFamily = FontFamily.Serif,
            modifier = Modifier.padding(start = 30.dp)
        )
        Spacer(modifier = Modifier.height(10.dp))
...
@Composable
fun House1ScreenPreview(){
    House1Screen(rememberNavController())
}